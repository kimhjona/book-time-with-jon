...
function slotFor(date, hour) {
  ...
  return { iso: formatISOWithOffset(instant), display: hourLabel(hour) };
}
...
function jsonp(params, timeoutMs) {
  return new Promise((resolve, reject) => {
    ...
    const qs = Object.entries(params)
      ...
      .join('&');
    script.src = SCRIPT_URL + '?action=book&' + qs + '&callback=' + encodeURIComponent(cb);
